create or replace TABLE DB.SCH.PRJ_AUDIT_DTLS (
...
create or replace TABLE DB.SCH.PRJ_DATA_VLDTN_ADT_DTLS (
	BATCH_ID NUMBER(38,0),
	RULE_ID NUMBER(38,0),
...
create or replace TABLE DB.SCH.PRJ_DATA_VLDTN_RULE (
	RULE_ID NUMBER(38,0),
	SUB_AREA_NM VARCHAR(100),
	INTERFACE_NM VARCHAR(100),
	OBJECT_LAYER VARCHAR(100),
...
create or replace TABLE DB.SCH.PRJ_ERROR_DTLS (
	BATCH_ID NUMBER(38,0),
	RULE_ID NUMBER(38,0),
	RULE_TYPE VARCHAR(100),
	SUB_AREA_NM VARCHAR(100),
...
create or replace TABLE DB.SCH.PRJ_BATCH_RUN_DTLS (
	BATCH_ID NUMBER(38,0),
	APPLICATION_ID NUMBER(38,0),
	SUBJECT_AREA_NAME VARCHAR(200),
	EXECUTION_DATE DATE,
...
create or replace TABLE DB.SCH.PRJ_PARAMETER_TABLE (
...
create or replace TABLE DB.SCH.k_proj_name_APPLICATION_DTLS (
	APPLICATION_ID NUMBER(38,0) autoincrement start 1 increment 1 order,
