create or replace TABLE COMETL_CONTROL_TEST_DB.COMETL_CONTROL_EMEA.AUDIT_DTLS (
...
create or replace TABLE COMETL_CONTROL_TEST_DB.COMETL_CONTROL_EMEA.DATA_VLDTN_ADT_DTLS (
	BATCH_ID NUMBER(38,0),
	RULE_ID NUMBER(38,0),
...
create or replace TABLE COMETL_CONTROL_TEST_DB.COMETL_CONTROL_EMEA.DATA_VLDTN_RULE (
	RULE_ID NUMBER(38,0),
	SUB_AREA_NM VARCHAR(100),
	INTERFACE_NM VARCHAR(100),
	OBJECT_LAYER VARCHAR(100),
...
create or replace TABLE COMETL_CONTROL_TEST_DB.COMETL_CONTROL_EMEA.ERROR_DTLS (
	BATCH_ID NUMBER(38,0),
	RULE_ID NUMBER(38,0),
	RULE_TYPE VARCHAR(100),
	SUB_AREA_NM VARCHAR(100),
...
create or replace TABLE COMETL_CONTROL_TEST_DB.COMETL_CONTROL_EMEA.BATCH_RUN_DTLS (
	BATCH_ID NUMBER(38,0),
	APPLICATION_ID NUMBER(38,0),
	SUBJECT_AREA_NAME VARCHAR(200),
	EXECUTION_DATE DATE,
...
create or replace TABLE COMETL_CONTROL_TEST_DB.COMETL_CONTROL_EMEA.PARAMETER_TABLE (
