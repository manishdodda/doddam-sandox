...
----------Selecting active batch
		...
		var SQ_BATCH_ID = `SELECT BATCH_ID FROM COMETL_CONTROL_TEST_DB.COMETL_CONTROL_EMEA.BATCH_RUN_DTLS WHERE UPPER(SUBJECT_AREA_NAME)=UPPER(''`+ P_SUB_AREA_NM +`'') AND LOAD_STATUS=''R''`;
		//return SQ_BATCH_ID;
